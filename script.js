...
function updateUI() {
    ...
    if (game.escort >= 1) {
        ...
        document.getElementById('btn-esc-1').innerText = "ESCORT I OWNED";
        document.getElementById('btn-esc-1').disabled = true;
    }
    if (game.escort >= 2) {
        document.getElementById('escort-right').classList.remove('hidden');
        document.getElementById('btn-esc-2').innerText = "ESCORT II OWNED";
...
function gameTick() {
    ...
    if (game.dist > game.record) game.record = game.dist;
